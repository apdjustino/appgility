...
const Step3 = ({ activeStep, eventMeta, setActiveStep }: OwnProps) => {
    ...
    return (
        <>
            ...
            {!!showError ? <Alert variant="danger">{showError}</Alert> : null}
            ...
            <div className="row">
                <div className="col">
                    <div className="d-flex">
                        ...
                        <Form.Check label="Payment Received" checked={paymentReceived} onChange={() => setPaymentReceived(!paymentReceived)} />
                    </div>
                </div>
            </div>
            <hr className="my-5" />
            <Nav className="row align-items-center">
                <div className="col-auto">
                    <Button variant="white" type="button" size="lg" onClick={() => setActiveStep(1)}>
                        Back
                    </Button>
                </div>
                ...
                <div className="col-auto">
                    ...
                    >
                        {result.loading ? <Spinner animation="border" /> : "Finish"}
                    </Button>
                </div>
            </Nav>
        </>
