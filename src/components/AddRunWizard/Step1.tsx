    ...
    return (
        <>
            ...
            <div className="row">
                            ...
                            renderMenuItemChildren={(option: PersonView, props: any) => {
                                ...
                                return (
                                    <>
                                        ...
                                        <Highlighter search={props.text}>{`${option.name} - ${option.email}`}</Highlighter>
                                    </>
                                );
                            }}
                ...
                <div className="col-auto">
                    <div className="d-block d-md-none">
                        <button className="btn btn-white btn-rounded-circle" onClick={() => setShowAddPersonModal(true)}>
                            +
                        </button>
                    </div>
                    <div className="d-none d-md-block">
                        <button className="btn btn-white" onClick={() => setShowAddPersonModal(true)}>
                            Add New Exhibitor
                        </button>
                    </div>
                </div>
            ...
            <Nav className="row align-items-center">
                <div className="col-auto">
                    <Button variant="white" type="button" size="lg">
                        Cancel
                    </Button>
                </div>
