                                                                        ...
                                                                        <div className="w-100">
                                                                            <Form.Control
                                                                                ...
                                                                                onChange={(newValue: any) =>
                                                                                    formik.setFieldValue(`trials.${index}.standardLevel`, newValue)
                                                                                }
                                                                                disabled={!runFormData.dog.dogId}
                                                                                isInvalid={
                                                                                    !!formik.touched.trials &&
                                                                                    !!formik.touched.trials[index].standardLevel &&
                                                                                    !!formik.errors.trials &&
                                                                                    !!(formik.errors.trials[index] as any).standardLevel
                                                                                }
                                                                            />
                                                                            <Form.Control.Feedback type="invalid">
                                                                                {!!formik.errors && !!formik.errors.trials
                                                                                    ? (formik.errors.trials[index] as any).standardLevel
                                                                                    : ""}
                                                                    ...
                                                                    <div className="col-md-6 col-12 d-flex">
                                                                        <div className="w-100">
                                                                            <Form.Control
                                                                                ...
                                                                                onChange={(newValue: any) =>
                                                                                    formik.setFieldValue(`trials.${index}.standardHeight`, newValue)
                                                                                }
                                                                                disabled={!runFormData.dog.dogId}
                                                                                isInvalid={
                                                                                    !!formik.touched.trials &&
                                                                                    !!formik.touched.trials[index].standardHeight &&
                                                                                    !!formik.errors.trials &&
                                                                                    !!(formik.errors.trials[index] as any).standardHeight
                                                                                }
                                                                            />
                                                                            <Form.Control.Feedback type="invalid">
                                                                                {!!formik.errors && !!formik.errors.trials
                                                                    ...
                                                                    <div className="col-md-6 col-12 d-flex border-end">
                                                                        ...
                                                                        <div className="w-100">
                                                                            <Form.Control
                                                                                ...
                                                                                onChange={(newValue: any) =>
                                                                                    formik.setFieldValue(`trials.${index}.jumpersLevel`, newValue)
                                                                                }
                                                                                disabled={!runFormData.dog.dogId}
                                                                                isInvalid={
                                                                                    !!formik.touched.trials &&
                                                                                    !!formik.touched.trials[index].jumpersLevel &&
                                                                                    !!formik.errors.trials &&
                                                                                    !!(formik.errors.trials[index] as any).jumpersLevel
                                                                                }
                                                                            />
                                                                            <Form.Control.Feedback type="invalid">
                                                                                {!!formik.errors && !!formik.errors.trials
                                                                    ...
                                                                    <div className="col-md-6 col-12 d-flex">
                                                                        <div className="w-100">
                                                                            <Form.Control
                                                                                ...
                                                                                onChange={(newValue: any) =>
                                                                                    formik.setFieldValue(`trials.${index}.jumpersHeight`, newValue)
                                                                                }
                                                                                disabled={!runFormData.dog.dogId}
                                                                                isInvalid={
                                                                                    !!formik.touched.trials &&
                                                                                    !!formik.touched.trials[index].jumpersHeight &&
                                                                                    !!formik.errors.trials &&
                                                                                    !!(formik.errors.trials[index] as any).jumpersHeight
                                                                                }
                                                                            />
                                                                            <Form.Control.Feedback type="invalid">
                                                                                {!!formik.errors && !!formik.errors.trials
                                                                    ...
                                                                    <div className="col-md-6 col-12 d-flex border-end">
                                                                        ...
                                                                        <div className="w-100">
                                                                            <Form.Control
                                                                                ...
                                                                                onChange={(newValue: any) =>
                                                                                    formik.setFieldValue(`trials.${index}.fastLevel`, newValue)
                                                                                }
                                                                                disabled={!runFormData.dog.dogId}
                                                                                isInvalid={
                                                                                    !!formik.touched.trials &&
                                                                                    !!formik.touched.trials[index].fastLevel &&
                                                                                    !!formik.errors.trials &&
                                                                                    !!(formik.errors.trials[index] as any).fastLevel
                                                                                }
                                                                            />
                                                                            <Form.Control.Feedback type="invalid">
                                                                                {!!formik.errors && !!formik.errors.trials
                                                                    ...
                                                                    <div className="col-md-6 col-12 d-flex">
                                                                        <div className="w-100">
                                                                            <Form.Control
                                                                                ...
                                                                                onChange={(newValue: any) =>
                                                                                    formik.setFieldValue(`trials.${index}.fastHeight`, newValue)
                                                                                }
                                                                                disabled={!runFormData.dog.dogId}
                                                                                isInvalid={
                                                                                    !!formik.touched.trials &&
                                                                                    !!formik.touched.trials[index].fastHeight &&
                                                                                    !!formik.errors.trials &&
                                                                                    !!(formik.errors.trials[index] as any).fastHeight
                                                                                }
                                                                            />
                                                                            <Form.Control.Feedback type="invalid">
                                                                                {!!formik.errors && !!formik.errors.trials
                                                                    ...
                                                                    <div className="col-12 d-flex border-end">
                                                                        <div className="w-100">
                                                                            <Form.Control
                                                                                ...
                                                                                onChange={(newValue: any) =>
                                                                                    formik.setFieldValue(`trials.${index}.t2bHeight`, newValue)
                                                                                }
                                                                                disabled={!runFormData.dog.dogId}
                                                                                isInvalid={
                                                                                    !!formik.touched.trials &&
                                                                                    !!formik.touched.trials[index].t2bHeight &&
                                                                                    !!formik.errors.trials &&
                                                                                    !!(formik.errors.trials[index] as any).t2bHeight
                                                                                }
                                                                            />
                                                                            <Form.Control.Feedback type="invalid">
                                                                                {!!formik.errors && !!formik.errors.trials
                                                                    ...
                                                                    <div className="col-12 d-flex border-end">
                                                                        <div className="w-100">
                                                                            <Form.Control
                                                                                ...
                                                                                onChange={(newValue: any) =>
                                                                                    formik.setFieldValue(`trials.${index}.premierStandardHeight`, newValue)
                                                                                }
                                                                                disabled={!runFormData.dog.dogId}
                                                                                isInvalid={
                                                                                    !!formik.touched.trials &&
                                                                                    !!formik.touched.trials[index].premierStandardHeight &&
                                                                                    !!formik.errors.trials &&
                                                                                    !!(formik.errors.trials[index] as any).premierStandardHeight
                                                                                }
                                                                            />
                                                                            <Form.Control.Feedback type="invalid">
                                                                                {!!formik.errors && !!formik.errors.trials
                                                                    ...
                                                                    <div className="col-12 d-flex border-end">
                                                                        <div className="w-100">
                                                                            <Form.Control
                                                                                ...
                                                                                onChange={(newValue: any) =>
                                                                                    formik.setFieldValue(`trials.${index}.premierJumpersHeight`, newValue)
                                                                                }
                                                                                disabled={!runFormData.dog.dogId}
                                                                                isInvalid={
                                                                                    !!formik.touched.trials &&
                                                                                    !!formik.touched.trials[index].premierJumpersHeight &&
                                                                                    !!formik.errors.trials &&
                                                                                    !!(formik.errors.trials[index] as any).premierJumpersHeight
                                                                                }
                                                                            />
                                                                            <Form.Control.Feedback type="invalid">
                                                                                {!!formik.errors && !!formik.errors.trials
